...
void Robot2::getVector()
{
    //get the bond and stock vectors
    v = uf->getClient()->getBondVector();
    m = uf->getClient()->getMMVector();
//    cout << endl << "Robot 2 Getting Bond Lists from Server: " << v << endl;
//    cout << endl << "Robot 2 Getting MM Lists from Server: " << m << endl;
...
void Robot2::updateAccount()
{
    double money = uf->getMoneyInvested();
    double bondmoney = (money * 0.7);
...
void Robot2::printAllNewandOldVectorElements()
{

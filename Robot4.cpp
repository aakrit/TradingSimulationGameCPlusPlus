...
void Robot4::getVector()
{
    //get the bond and stock vectors
    v = uf->getClient()->getStockVector();
    m = uf->getClient()->getMMVector();
    b = uf->getClient()->getBondVector();
//    cout << endl << "Robot 4 Getting Stock Lists from Server: " << v << endl;
//    cout << endl << "Robot 4 Getting MM Lists from Server: " << m << endl;
//    cout << endl << "Robot 4 Getting Bond Lists from Server: " << m << endl;
...
void Robot4::rearrangeVector()
{
    sort(stockList.begin(), stockList.end(), SortFinancialObjectVectorDSC());
...
void Robot4::updateAccount()
{
    double money = uf->getMoneyInvested();
    double bondMoney = (money * 0.3);
    double mmMoney = (money * 0.6);
    double stockmoney = (money * 0.1);
...
//        cout << "Bond Investment Complete" << endl;
...
void Robot4::printAllNewandOldVectorElements()
{
